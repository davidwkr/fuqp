...
import com.iodvd.fuqp.common.Constants.CONFIG_VERSION_NO_SETTINGS
...
import com.iodvd.fuqp.ui.util.contentResolver
...
import com.iodvd.fuqp.util.PackageHelper.loadAppLabel
import kotlinx.coroutines.launch
import com.iodvd.fuqp.R
import com.iodvd.fuqp.databinding.FragmentBackupRestoreBinding
import com.iodvd.fuqp.databinding.LayoutListEmptyBinding
...
class BackupRestoreFragment : Fragment(R.layout.fragment_backup_restore) {
    ...
    private fun onMenuOptionSelected(item: MenuItem) {
        if (isBackupMode) {
            ...
            backupSAFLauncher.launch("FUQP_config_$date.json")
        } else {
            onRestore()
        }
    }
