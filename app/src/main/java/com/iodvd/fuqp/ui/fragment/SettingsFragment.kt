...
import com.iodvd.fuqp.databinding.FragmentSettingsBinding
import com.iodvd.fuqp.ui.activity.MainActivity
import com.iodvd.fuqp.ui.fragment.AppSettingsV2FragmentArgs
import com.iodvd.fuqp.ui.preference.AppIconPreference
...
class SettingsFragment : Fragment(R.layout.fragment_settings), PreferenceFragmentCompat.OnPreferenceStartFragmentCallback {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        runBlocking {
            PrefManager.isLauncherIconInvisible.emit(findEnabledAppComponent(fuqpApp) == null)
        }
    ...
    class SettingsPreferenceDataStore : PreferenceDataStore() {
        ...
        override fun putBoolean(key: String, value: Boolean) {
            when (key) {
                ...
                "enableInternet" -> PrefManager.setEnableInternet(value)
