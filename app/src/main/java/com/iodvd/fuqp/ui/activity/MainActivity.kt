package com.iodvd.fuqp.ui.activity
...
import com.iodvd.fuqp.ui.util.ThemeUtils
import com.iodvd.fuqp.util.ConfigUtils
import com.iodvd.fuqp.BuildConfig
import com.iodvd.fuqp.R
import com.iodvd.fuqp.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun getLocaleAppliedContext(context: Context?): Context? {
        val config = fuqpApp.resources.configuration
