...
object PrefManager {
    ...
    private val pref = fuqpApp.getSharedPreferences("settings", MODE_PRIVATE)
    ...
    var hideIcon: Boolean
        ...
        set(value) {
            val enabled = findEnabledAppComponent(fuqpApp)
            if (value && enabled != null) {
                fuqpApp.packageManager.setComponentEnabledSetting(
                    enabled,
                ...
                fuqpApp.packageManager.setComponentEnabledSetting(
                    ComponentName(fuqpApp, AppConstants.COMPONENT_NAME_DEFAULT),
